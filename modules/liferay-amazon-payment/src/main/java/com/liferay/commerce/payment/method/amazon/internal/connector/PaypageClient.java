...
package com.liferay.commerce.payment.method.amazon.internal.connector;
...
public class PaypageClient {
	...
	public PaypageClient(
			Environment environment, String merchantId,
			String secretKey)
		throws Exception {
	...
	private void _verifySeal(String data, String seal) throws Exception {
		String correctSeal = DigestUtils.sha256Hex(data + _accessCode);
